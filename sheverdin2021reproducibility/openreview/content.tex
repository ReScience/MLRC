...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\linewidth]{\detokenize{images/complex-network.png}}
...
% \begin{figure}[!h]
%     \centering
%     \includegraphics[width=0.24\textwidth]{original images.png}
%     \includegraphics[width=0.24\textwidth]{reconstructed images.png}
...
\begin{figure}[!tbp]
    ...
    \begin{subfigure}{.5\textwidth}
      \centering
      \includegraphics[width=0.45\textwidth]{lenet_original.png}
        \includegraphics[width=0.45\textwidth]{lenet_reconstruct.png}
    ...
    \begin{subfigure}{.5\textwidth}
        \captionsetup{labelformat=empty}
        \includegraphics[width=0.45\textwidth]{original images.png}
        \includegraphics[width=0.45\textwidth]{reconstructed images.png}
...
% 		\centering
% 		\includegraphics[width=40mm]{\detokenize{original images.png}}
...
\begin{table}
	...
	\begin{minipage}{0.45\linewidth}
    	\centering
    	\setlength{\abovecaptionskip}{5pt}
        \includegraphics[width=0.9\textwidth]{images/image_reconstructions.PNG}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{images/diagram_training.png}
...
% \begin{figure}
%     \centering
%     \includegraphics[width=0.3\textwidth]{images/swap.png}
