...
\begin{figure}[!htbp]
    \centering
    %\makebox[\textwidth][c]{\includegraphics[width=1.25\textwidth]{../openreview/pictures/mnist_149/alpha_1_149_high_reso.png}}
...
\centering
    \begin{subfigure}[t]{.45\linewidth}
        \includegraphics[width=.9\textwidth]{ablation study 034/InformationFlow.png}
         \caption{Information flow.}
        % \label{fig:5a}
    \end{subfigure}
     \begin{subfigure}[t]{.45\linewidth}
        \includegraphics[width=.9\textwidth]{ablation study 034/AblationAccuracy.png}
