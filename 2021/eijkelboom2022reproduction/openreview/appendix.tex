...
\begin{tabular}{|m{.7cm}|m{2.6cm}|m{1.2cm}|m{.9cm}|m{1.3cm}|m{1.3cm}|m{1.4cm}|m{1.4cm}|}
\hline
...
Bank      & Marketing campaigns of a Portuguese banking institution corresponding to each client                                                      & 41,188                                                             & Marital status      & single, married, divorced, unknown                                            & \begin{tabular}[c]{@{}c@{}}Removing \\ unknown\end{tabular} & 41,108                                                                    & \begin{tabular}[c]{@{}l@{}}6 categorical, \\ 4 binary, \\ 6 numerical\end{tabular} \\ \hline
