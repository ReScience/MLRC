...
\begin{figure}[t!]
    \centering
    \subfigure{\includegraphics[width=\textwidth]{images/original_faces.png}} 
    \subfigure{\includegraphics[width=\textwidth]{images/re_faces.png}} 
...
\begin{figure}[t]
    \centering
    \subfigure{\includegraphics[width=0.6\textwidth]{images/original_light.png}} 
    \subfigure{\includegraphics[width=0.6\textwidth]{images/re_light.png}} 
...
\begin{figure}[t!]
    \centering
    \subfigure{\includegraphics[width=0.6\textwidth]{images/celeba_faces.png}} 
    \subfigure{\includegraphics[width=0.6\textwidth]{images/celeba_yaw.png}}
    \subfigure{\includegraphics[width=0.6\textwidth]{images/celeba_pitch.png}}
    \subfigure{\includegraphics[width=0.4\textwidth]{images/celeba_light.png}}
