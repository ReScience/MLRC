...
\begin{figure}[t!]
    \centering
    \subfloat{\includegraphics[width=\textwidth]{images/original_faces.png}} //
    \subfloat{\includegraphics[width=\textwidth]{images/re_faces.png}} 
...
\begin{figure}[t]
    \centering
    \subfloat{\includegraphics[width=0.6\textwidth]{images/original_light.png}} //
    \subfloat{\includegraphics[width=0.6\textwidth]{images/re_light.png}} 
...
\begin{figure}[t!]
    \centering
    \subfloat[a]{\includegraphics[width=0.6\textwidth]{images/celeba_faces.png}} //
    \subfloat[b]{\includegraphics[width=0.6\textwidth]{images/celeba_yaw.png}}   //
    \subfloat[c]{\includegraphics[width=0.6\textwidth]{images/celeba_pitch.png}}  //
    \subfloat[d]{\includegraphics[width=0.4\textwidth]{images/celeba_light.png}} //
