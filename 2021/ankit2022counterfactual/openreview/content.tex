...
% \tiny
% \begin{tabular}{@{}c@{}c}
% \includegraphics[width=0.4\textwidth]{../openreview/images/mask_original.pdf} &

% \includegraphics[width=0.4\textwidth]{../openreview/images/mask_ssim.pdf} \\
% \scriptsize (a) Wildlife MNIST mask samples 
% obtained using default hyper-parameters 
% mentioned in CGN \cite{sauer2021counterfactual}. & 
% \scriptsize (b) Wildlife MNIST mask samples 
% obtained by adding SSIM \cite{wang2004image} loss.
% \end{tabular}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.5\textwidth}
      ...
      \caption{Wildlife MNIST mask samples obtained using \\default hyper-parameters mentioned in CGN \cite{sauer2021counterfactual}.
      }
    ...
    \begin{subfigure}{0.5\textwidth}
      ...
      \caption{Wildlife MNIST mask samples obtained by adding SSIM \cite{wang2004image} loss.
      }
