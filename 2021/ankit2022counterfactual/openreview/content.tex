...
% \centering
%     \includegraphics[width=0.7\textwidth,height=0.3\textwidth]{./ankit2022counterfactual/openreview/images/arch_diagram.pdf}
...
% pending: The settings that we used for MNIST \cite{lecun1998gradient} dataset.
...
% pending: mention about hyperapameter of learning rate changing in case of mini imagenet. Can add hyperamater based results. how tweaking the hyperpamaters leads to change in observed result. 


% Include a description of how the experiments were set up that's clear enough a reader could replicate the setup. 
% Include a description of the specific measure used to evaluate the experiments (e.g. accuracy, precision@K, BLEU score, etc.). 
% Provide a link to your code.
% pending: elaborate about the inception score here and cite the repo here. Additionally, i don't think we used any other metrics apart from the ones that were already present. 
...
% pending: Usage of one gpu everywhere, mark can run a script to print the details of GPU from his side. 
...
% \subsection{Metrics that have been used throughout all the experiments}
% \textbf{ImageNet, miniImageNet, ImageNet1k tables}: pending: top1, top5, classification accuracy. 

% \textbf{MNIST dataset tables}: For datsasets such as Wildlife MNIST, colored MNIST, and double colored MNIST the CGN \cite{sauer2021counterfactual} paper makes use of standard accuracy to test the classifier's performance on the downstream task on obtaining the counterfactual samples from the CGN \cite{sauer2021counterfactual} network. 
% For the task of counterfactual images generation: the 
% pending: Waiting for imagenet-1k results 
...
%         \includegraphics{../openreview/images/mnist_CGNs/0_46000_x_gen_double_colored_crop.png}
%         \caption{No noise \\ }
%         \label{fig:image1-noise-a}
%     \end{subfigure} \hfill
%     \begin{subfigure}[b]{0.33\textwidth}
%         \includegraphics{../openreview/images/mnist_CGNs/0_46000_x_gen_double_colored_crop.png}
%         \caption{Salt-and-pepper noise \\ }
%         \label{fig:image1-noise-b}
%     \end{subfigure} \hfill
%     \begin{subfigure}[b]{0.33\textwidth}
%         \includegraphics{../openreview/images/mnist_CGNs/0_46000_x_gen_double_colored_crop.png}
%         \caption{Gaussian noise \\ }
%         \label{fig:image1-noise-c}
%     \end{subfigure} \hfill
    
%     \label{fig:image1-noise}
% \end{figure}
...
% \begin{figure}[ht!]
% \centering
%     \includegraphics[width=0.8\textwidth,height=0.5\textwidth]{../openreview/counterfactuals/good_image.png}
%     \caption{Counterfactual Images from the Pre-trained CGN given in the original paper
%     }
...
% \begin{figure}[ht]
% \centering
%     \includegraphics[width=0.8\textwidth,height=0.5\textwidth]{../openreview/counterfactuals/bad_image.png}
%     \caption{Counterfactual Images that have poorer x_{gen}
%     }
...
% @Sameer old para included a lot of info about the content of fig 3 and 4. I think best to include that info in the fig captions. works. please paste old para, i will push it to figure caption. Ok. 
...
% \begin{table}[h]
% \centering
% \caption{Shape Bias for ImageNet-1k(Mini), ImageNet-1k(mini)+CGN}
% \begin{tabular}{|l|l|l|}
% \toprule
% {} & Pre-trained Resnet-50 & Classifier Ensemble\\
% Top 5 classes & Probability(in \%) & Probability(in \%) \\
% \midrule
% \hline
% & & &
%  &    \textbf{iPod} : 96.23\%  & American\_chameleon : 53.17\% \\
%     & loudspeaker : 3.75\% & terrapin : 45.90\% \\
%     & radio : 6.02e-05\% & bald\_eagle : 0.72\% \\
%     & remote\_control : 2.98e-05\% & whiptail : 0.03 \% \\
%     & ant : 1.28e-05\% & \textbf{iPod} : 0.02\%
%  \\

% \label{table:classifier_robustness}
% \end{tabular}
% \end{table}
\section{Discussion}
...
% \begin{table}
% \centering
% \caption{Accuracy for classifier trained on colored MNIST using pretrained weights}
% \begin{tabular}{lrrr}
% \toprule
% {} &  CF Ratio: 1 &  CF Ratio: 5 &  CF Ratio: 10 \\
% Num counterfactuals &              &              &               \\
% \midrule
% $10^4$              &        92.57 &        92.09 &         91.32 \\
% $10^5$              &        96.34 &        96.26 &         96.42 \\
% $10^6$              &        95.96 &        96.77 &         96.98 \\
% \bottomrule
% \end{tabular}
% \end{table}
...
% \begin{table}
% \centering
% \caption{Accuracy for classifier trained on colored MNIST using trained weights}
% \begin{tabular}{lrrr}
% \toprule
% {} &  CF Ratio: 1 &  CF Ratio: 5 &  CF Ratio: 10 \\
% Num counterfactuals &              &              &               \\
% \midrule
% $10^4$              &        56.53 &        56.72 &         58.51 \\
% $10^5$              &        61.90 &        63.94 &         61.12 \\
% $10^6$              &        68.39 &        70.29 &         68.96 \\
% \bottomrule
% \end{tabular}
% \end{table}
...
% \begin{table}
% \centering
% \caption{Accuracy for classifier trained on double colored MNIST using pretrained weights}
% \begin{tabular}{lrrrr}
% \toprule
% {} &  CF Ratio: 1 &  CF Ratio: 5 &  CF Ratio: 10 &  CF Ratio: 20 \\
% Num counterfactuals &              &              &               &               \\
% \midrule
% $10^4$              &        72.80 &        74.61 &         74.02 &         72.34 \\
% $10^5$              &        87.52 &        88.35 &         87.72 &         86.26 \\
% $10^6$              &        92.36 &        91.82 &         92.50 &         92.29 \\
% \bottomrule
% \end{tabular}
% \end{table}
...
% \begin{table}
% \centering
% \caption{Accuracy for classifier trained on double colored MNIST using trained weights}
% \begin{tabular}{lrrrr}
% \toprule
% {} &  CF Ratio: 1 &  CF Ratio: 5 &  CF Ratio: 10 &  CF Ratio: 20 \\
% Num counterfactuals &              &              &               &               \\
% \midrule
% $10^4$              &        75.40 &        74.54 &         74.44 &         76.10 \\
% $10^5$              &        85.62 &        85.21 &         85.74 &         86.19 \\
% $10^6$              &        88.50 &        88.06 &         88.16 &         88.54 \\
% \bottomrule
% \end{tabular}
% \end{table}
...
% \begin{table}
% \centering
% \caption{Accuracy for classifier trained on wildlife MNIST using pretrained weights}
% \begin{tabular}{lrrrr}
% \toprule
% {} &  CF Ratio: 1 &  CF Ratio: 5 &  CF Ratio: 10 &  CF Ratio: 20 \\
% Num counterfactuals &              &              &               &               \\
% \midrule
% $10^4$              &        34.99 &        38.03 &         39.34 &         42.08 \\
% $10^5$              &        70.40 &        70.58 &         68.36 &         71.98 \\
% $10^6$              &        87.32 &        87.46 &         87.76 &         88.35 \\
% \bottomrule
% \end{tabular}
% \end{table}
...
% \begin{table}
% \centering
% \caption{Accuracy for classifier trained on wildlife MNIST using trained weights}
% \begin{tabular}{lrrrr}
% \toprule
% {} &  CF Ratio: 1 &  CF Ratio: 5 &  CF Ratio: 10 &  CF Ratio: 20 \\
% Num counterfactuals &              &              &               &               \\
% \midrule
% $10^4$              &        42.03 &        43.47 &         40.01 &         43.26 \\
% $10^5$              &        60.10 &        63.46 &         62.54 &         61.94 \\
% $10^6$              &        71.79 &        72.47 &         73.59 &         72.93 \\
% \bottomrule
% \end{tabular}
% \end{table}
...
% \begin{table}
% \centering
% \caption{Accuracy for MNIST datsaets when Color Jitter augmentation is used.   }
% \begin{tabular}{lrrrr}
% \toprule
% {} & using pretrained weights &  training from scratch & trained from scratch\\
% Datasets  &              &              &                            \\
% \midrule
% Colored              &        96.42 &        61.12 &         _  \\
...
\newpage
\begin{appendices}
% The Appendix section has been categorized as:
% \begin{itemize}
%   \item Section A: 
%   \item Section B: 
%   \item Section C: 
...
% \begin{figure}[ht!]
% \centering
%     \includegraphics[width=0.8\textwidth,height=0.5\textwidth]{../openreview/images/mask_original.pdf}
%     \caption{Colored MNIST mask samples obtained using default hyper-parameters mentioned in CGN \cite{sauer2021counterfactual}.
%     }
%     \label{fig:original_grid_mask}
% \end{figure}
...
% !!!!! Change this to include the figure in the main paper
% \begin{figure}[ht!]
%     \centering
...
% \begin{figure}[ht!]
% \centering 
%     \includegraphics[width=0.8\textwidth,height=0.5\textwidth]{../openreview/images/x_gen_data_augment.pdf}
