...
To use the components $\textbf{v}$, $\textbf{l}$, $\textbf{d}$ and  $\textbf{a}$ to obtain a reconstructed image, the authors utilize a pretrained neural renderer developed by \cite{neural-renderer}, which we denote by $\Phi$.
