...
\def \articleTITLE{[Re] Strategic classification made practical: reproduction}
...
\def \articleDOI{10.5281/zenodo.6574665}
\def \authorsFULL{Guilly Kolkman et al.}
\def \authorsABBRV{G. Kolkman et al.}
\def \authorsSHORT{Kolkman et al.}
\title{\articleTITLE}
\date{}
