...
\begin{table*}
	...
	\begin{tabular}{lcccc}
		\toprule
		\multirow{2}{c}{Dataset} & \multirow{2}{c}{No augmentation} & \multirow{2}{c}{Shift\\ ($5$ pixel left and up)} & \multirow{2}{c}{Flip} & \multirow{2}{c}{Rotation \\ ($\ang{90}$ clockwise)} \\
		\midrule
...
\begin{table*}
	...
	\begin{tabular}{llccccc}
		...
		%& Proposed method &  $66.54$ & $ 58.72$ & $57.81$ & $57.51$ & $41.60 $ \\
