...
% Below, we detail the procedure for computing inference and train FLOPs of specific methods.

\subsection{Inference FLOPs}

% As mentioned above, we determine the inference FLOPs of each model given its layer-wise sparsity distribution (specified by the boolean masks). Below we highlight the 
