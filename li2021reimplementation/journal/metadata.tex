...
\def \articleNUMBER{}
\def \articleDOI{}
\def \authorsFULL{name, name and Hui Zhang}
\def \authorsABBRV{ name,  name and H. Zhang}
\def \authorsSHORT{name, name and Zhang}
\title{\articleTITLE}
\date{}
\author[1,\orcid{0000-0003-0330-9428}]{name}
\author[1,\orcid{0000-0003-0330-9428}]{name}
\author[1,\orcid{0000-0002-0992-5830}]{Hui Zhang}
