...
\def \articleNUMBER{}
\def \articleDOI{}
\def \authorsFULL{Maarten Boon et al.}
\def \authorsABBRV{M. Boon et al.}
\def \authorsSHORT{Boon et al.}
\title{\articleTITLE}
\date{}
\author[1,\orcid{0000-0002-0634-8169}]{Maarten Boon}
\author[1,\orcid{0000-0002-0634-8169}]{Stijn Henckens}
\author[1,\orcid{0000-0002-0634-8169}]{Lysander de Jong}
