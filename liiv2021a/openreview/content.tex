...
Using these models and dataset we ran a number of experiments, as detailed below. The full code is available on \href{https://anonymous.4open.science/r/4ee2c9ef-295f-44e2-8214-f0818b932817/}{https://anonymous.4open.science/r/4ee2c9ef-295f-44e2-8214-f0818b932817/}. Our implementation was made in TensorFlow Keras, as opposed to the original implementation which was made in PyTorch.
...
\begin{figure}[h!]
    \centering
    \includegraphics[trim = 70 54 100 100, clip, width = 0.85\textwidth]{plots/Figure_8.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[trim = 55 19 55 50, clip, width = 0.8\textwidth]{plots/Figure_11.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.8\linewidth]{plots/all_simplex.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim = 0 0 0 20, clip, width = 1\linewidth]{plots/simplex_in.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[trim = 0 0 0 20, clip, width = 1\linewidth]{plots/simplex_out.png}
